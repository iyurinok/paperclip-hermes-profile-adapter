...
import type { AdapterSkillEntry, AdapterSkillSnapshot, HermesProfileSkillContext } from "./types.js";
...
export async function listHermesProfileSkills(ctx: HermesProfileSkillContext): Promise<AdapterSkillSnapshot> {
...
export async function syncHermesProfileSkills(ctx: HermesProfileSkillContext, desiredSkills: string[] = []): Promise<AdapterSkillSnapshot> {
